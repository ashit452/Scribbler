          ...
          <div class="card">
            ...
            <form action="categoryadd.jsp" method="post">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                      <input class="form-control" maxlength="25" name="CategoryName" autocomplete="off" id="CategoryName" type="text" placeholder="Enter CategoryName" required/>
                      ...
                      %>
                      	<tr>
                      		<td><% out.print(rs.getString("Category")); %></td>
            					<td><a href="deletecategory.jsp?id=<%= rs.getInt("Catid")%>">delete</a> / <a href="updatecategory.jsp?id=<%= rs.getInt("Catid")%>">Update</a></td>
    					</tr>
    					<%
                      	}
    					%>
