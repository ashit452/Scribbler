                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    Dbhelper db=new Dbhelper();
                  	...
                  	ResultSet rs=db.execquery("select * from category where Catid='"+id+"'");
                  	while(rs.next()){
                    %>
                      <input class="form-control" maxlength="25" name="Categoryname" autocomplete="off" id="CategoryName" type="text" value="<%=rs.getString("Category") %>" placeholder="Enter CategoryName" required/>
                      <input class="form-control" maxlength="25" name="Categoryid" autocomplete="off" id="CategoryName" type="hidden" value="<%=rs.getInt("Catid") %>" placeholder="Enter CategoryName" required/>
                      <% 
                  		}
                      %> 
                    </div>
