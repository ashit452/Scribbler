                ...
                <div class="col-12">
                  <div class="table-responsive">
					...
					<%
                      	...
                      	db.connectwithdb();
                      	ResultSet rs=db.execquery("select * from user_data where Role='U'");
                      	while(rs.next()){
                      %>
			        ...
			        <td><% if(rs.getString("Status").equals("A")){out.print("Active");}
			            ...
			            <td><a href="updateuser.jsp?id=<%= rs.getInt("Uid")%>&task=<%= "block" %>">Block</a> / 
			            <a href="updateuser.jsp?task=<%= "unblock" %>&id=<%= rs.getInt("Uid")%>">Unblock</a></td>
    					</tr>
    				<%} %>
                      </tbody>
                    </table>
